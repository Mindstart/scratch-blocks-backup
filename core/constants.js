 ...
 * @const {string}
 */
Blockly.STRING_VARIABLE_TYPE = 'str';
Blockly.BOOLEAN_VARIABLE_TYPE = 'boolean';
Blockly.ARRAY_NUM_VARIABLE_TYPE = 'array_num';
Blockly.ARRAY_CHAR_VARIABLE_TYPE = 'array_char';
